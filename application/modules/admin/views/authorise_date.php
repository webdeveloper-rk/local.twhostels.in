...
<div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">CARE TAKER Reports  </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
             
			<form   role="form" class="form-horizontal"   action="<?php echo site_url();?>admin/subadmin/authorisations_entries"  method="post" onsubmit="return validate(this)">
              <div class="box-body">
