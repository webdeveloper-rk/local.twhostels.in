...
<br><br>
            ...
            <div class="row">
			 ...
			 <div id="wrap" class="container">            
<label  >Choose one District</label>
            
            <div class="row">
                <div class="col-sm-5">
                    <select name="district_selected[]" id="district_to" class="form-control" size="8" multiple="multiple">
                       <?php foreach($district_rs->result() as $row)
			 {
			 ...
			 ?>
                ...
                <!--
                <div class="col-sm-2">
                    <button type="button" id="district_rightAll" class="btn btn-block"><i class="glyphicon glyphicon-forward"></i></button>
                    <button type="button" id="district_rightSelected" class="btn btn-block"><i class="glyphicon glyphicon-chevron-right"></i></button>
                    <button type="button" id="district_leftSelected" class="btn btn-block"><i class="glyphicon glyphicon-chevron-left"></i></button>
                    <button type="button" id="district_leftAll" class="btn btn-block"><i class="glyphicon glyphicon-backward"></i></button>
                </div>
                
                <div class="col-sm-5">
                    <select name="district_selected[]" id="district_to" class="form-control" size="8" multiple="multiple"></select>
                </div>-->
            </div>
...
<label  >Items</label>
 ...
 <script>
  ...
  function validateform(frm)
  {
	  ...
	  var option_selected_count = $('#district_to :selected').length;
	   if(option_selected_count==0)
	  {
		  alert("Please choose atleast one district");
		  document.getElementById("district_to").focus();
		  return false;
	  }
