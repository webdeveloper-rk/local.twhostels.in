            ...
            <div class="box-body">
			  ...
			  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
				 ...
				 ?>
				 <a href="<?php echo site_url('specials/approval_entryform/'.$this->ci_jwt->jwt_web_encode($item->item_id));?>" ><?php    echo $item->telugu_name."-".$item->item_name;;?></a>
				 <?php } ?>
				 </b></td>
                   ...
                   <td>
				    ...
				    <td>
					  <?php
							...
							if($status=="")
							{
								?><a href="<?php echo site_url('specials/approval_entryform/'.$item->item_id);?>" class="btn btn-info  noprint" >Send for Approval</a><?php
							}else {
