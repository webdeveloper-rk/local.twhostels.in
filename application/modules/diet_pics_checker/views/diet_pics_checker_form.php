...
<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b> Consumption entry for <b> </b> date of  <b><?php echo date('d-m-Y');?></b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
			   <div class="form-group">
				...
				<div class="form-group" id="oldstockform" style="display: <?php  if($item_used->$old_qty==0) { echo 'none'; } ?> ">
						 ...
						 <input type="text" name="old_price" value="<?php echo  number_format($item_used->$old_price,2);?>" class="form-control"  required  id="old_price" placeholder="Enter Price">
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                  ...
                  <input type="text" name="price" <?php if($this->config->item('dpc_rates')==true) {  echo " readonly "; } ?> value="<?php if($this->config->item('dpc_rates')==true) { 
					$dpc_rates = $this->session->userdata('dpc_rates');
				  echo number_format($dpc_rates[$item_id],2);} else { echo number_format($item_used->$price,2) ;}?>" class="form-control"  required  id="exampleInputprice" placeholder="Enter Price">
