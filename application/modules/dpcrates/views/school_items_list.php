...
<div class="box">
            <div class="box-header">
					 ...
					 <a href='<?php echo site_url('dpcrates/school/submit')?>' onclick='return confirm("Are you sure to submit?")' 
									class='btn btn-primary pull-right'>Submit for Approval</a>
					 <?php } ?>	
            ...
            <div class="box-body">
			  ...
			  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
				 ...
				 foreach($rset->result() as $item) { ?>                <tr role="row" class="odd">
                  <td class="sorting_1">
				  <?php if($allow_to_modify==true) { ?><a href='<?php echo site_url();?>dpcrates/school/dpc_entryform/<?php echo $item->item_id;?>'>
              ...
              <td>
                  ...
                  <?php if($allow_to_modify==true) { ?>
                  <td><a href='<?php echo site_url();?>dpcrates/school/dpc_entryform/<?php echo $item->item_id;?>'>Update</a></td><?php } ?>
                </tr>
				 <?php } ?>
