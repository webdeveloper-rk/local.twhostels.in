...
class image_CRUD {
    ...
    protected function _insert_table($file_name, $relation_id = null)
    {
		...
		$CI =& get_instance();
		  ...
		  $insert['school_id'] = $CI->session->userdata('school_id');
		  $insert['title'] = date('d-m-Y');
    ...
    protected function _get_delete_url($value)
    {
    	...
    	return site_url('gallery/'.$rsegments_array[1].'/'.$rsegments_array[2].'/delete_file/'.$value);
    }
    ...
    protected function _get_photos($relation_value = null)
    {
    	...
    	{
    		$this->ci->db->order_by($this->priority_field,'desc');
    	}
    	/*if(!empty($relation_value))
    	{
    		$this->ci->db->where('school_id', $relation_value);
    	}*/
		
		
		$CI2 =& get_instance();
		//$CI2->session->userdata('school_id');
		if($CI2->session->userdata("user_role") == "school")
		{
				$this->ci->db->where('school_id', $CI2->session->userdata('school_id') );
		}
		if($CI2->session->userdata("user_role") == "subadmin")
		{
				$sid = $CI2->uri->segment(4); 
				$this->ci->db->where('school_id', $sid  );
		}
	...
	protected function getState()
	{
		...
		{
			$upload_url = site_url('gallery/'.$rsegments_array[1].'/'.$rsegments_array[2].'/upload_file/'.$rsegments_array[3]);
			$ajax_list_url  = site_url('gallery/'.$rsegments_array[1].'/'.$rsegments_array[2].'/'.$rsegments_array[3].'/ajax_list');
			$ordering_url  = site_url('gallery/'.$rsegments_array[1].'/'.$rsegments_array[2].'/ordering');
			$insert_title_url  = site_url('gallery/'.$rsegments_array[1].'/'.$rsegments_array[2].'/insert_title');
		...
		{
			$upload_url = site_url('gallery/'.$rsegments_array[1].'/'.$rsegments_array[2].'/upload_file');
			$ajax_list_url  = site_url('gallery/'.$rsegments_array[1].'/'.$rsegments_array[2].'/ajax_list');
			$ordering_url  = site_url('gallery/'.$rsegments_array[1].'/'.$rsegments_array[2].'/ordering');
			$insert_title_url  = site_url('gallery/'.$rsegments_array[1].'/'.$rsegments_array[2].'/insert_title');
