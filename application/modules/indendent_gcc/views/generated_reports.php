			  ...
			  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
				 ...
				 <tr  >
							...
							<a href="<?php echo site_url("indendent_gcc/viewindent/".$vieweditencoded); ?>" class="btn btn-info pull-right">View   </a>  
							<a href="<?php echo site_url("indendent_gcc/downloadindent/".$vieweditencoded); ?>" class="btn btn-info  ">Download   </a>
