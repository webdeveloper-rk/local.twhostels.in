...
<div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">  Itemwise Day  Consumption Reports  </h3>
...
<?php echo $this->session->flashdata("message");?>
  ...
  <?php if($this->session->userdata("is_dco")!="1"){?>			
	 <div class="form-group" id="fg_report" style="">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="datepicker form-control"  style="width:130px;" value="<?php echo $this->input->post("from_date");?>" id="from_date" placeholder="From Date" name="from_date" required="">
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="datepicker form-control"  style="width:130px;" value="<?php echo $this->input->post("to_date");?>" id="to_date" placeholder="To Date" name="to_date" required="">
		  ...
		  <div class="box">
            <div class="box-header">
			 ...
			 <?php echo  $display_dates;?> <span style="color:#FF0000;"><?php if($rdata['report_for']!="") { echo "-". $rdata['report_for'];} ?></span></b></b> </h4>
            </div>
            <!-- /.box-header -->
			...
			<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" 
				aria-label="Engine version: activate to sort column ascending" style="width: 106px;">Amount</th> 
                ...
                <tbody>
				 ...
				 foreach($rset->result() as $item) {
				  ...
				  $total_consumed  =  $total_consumed  + $item->consumed_quantity;
				   $total_consumed_amount   =    $total_consumed_amount   + $item->amount;
				...
				<td class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" 
				aria-label="Rendering engine: activate to sort column descending" style="widtd: 126px;"><?php echo $school_names_codes[$item->school_id]['code'];?></td>
				<td class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" 
				aria-label="Rendering engine: activate to sort column descending" style="widtd: 126px;"><?php echo $school_names_codes[$item->school_id]['name'];?></td>
				...
				aria-label="Platform(s): activate to sort column ascending" style="widtd: 139px;"><?php echo $item->consumed_quantity;?></td>
				 <td class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" 
				aria-label="Platform(s): activate to sort column ascending" style="widtd: 139px;"><?php echo number_format( $item->amount,2);?></td>
				...
				aria-label="Engine version: activate to sort column ascending" style="widtd: 106px;" align="right"><b>Total </b></td> 
				...
				<td class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" 
				aria-label="Engine version: activate to sort column ascending" style="widtd: 106px;"><b><?php echo number_format( $total_consumed_amount,2);?></b></td>
