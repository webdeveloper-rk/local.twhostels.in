...
<div class="box box-primary">
 ...
 <div class="box-body"> <div class="box-footer">
		...
		<td></td>
			...
			<td colspan="1"><span class='h1c'>Used  Qty</span></td><td><span class='h1c'> Used Price</span></td>
			</tr>
			...
			<td>  <input type="text"  value="<?php echo $day_obj->purchase_quantity;?>"  placeholder="Enter   quantity" name="purchase_qty[<?php echo $day_obj->entry_id;?>]" required="" style="width:80px;"></td><td><input type="text"  value="<?php echo $day_obj->purchase_price;?>"  placeholder="Enter Price" name="purchase_price[<?php echo $day_obj->entry_id;?>]" required="" style="width:80px;"></td>
			 ...
			 <td>  <input type="hidden"  value="<?php echo $day_obj->session_1_qty;?>"  placeholder="Enter  quantity" name="bf_qty[<?php echo $day_obj->entry_id;?>]" required="" style="width:80px;"></td><td><input type="hidden"  value="<?php echo $day_obj->session_1_price;?>"  placeholder="Enter Price" name="bf_price[<?php echo $day_obj->entry_id;?>]" required="" style="width:80px;"></td>
			 
			 
			  <td>  <input type="hidden"  value="<?php echo $day_obj->session_2_qty;?>"  placeholder="Enter  quantity" name="lunch_qty[<?php echo $day_obj->entry_id;?>]" required="" style="width:80px;"></td><td><input type="hidden"  value="<?php echo $day_obj->session_2_price;?>"  placeholder="Enter Price" name="lunch_price[<?php echo $day_obj->entry_id;?>]" required="" style="width:80px;"></td>
			  
			  <td>  <input type="hidden"  value="<?php echo $day_obj->session_3_qty;?>"  placeholder="Enter  quantity" name="snacks_qty[<?php echo $day_obj->entry_id;?>]" required="" style="width:80px;"></td><td><input type="hidden"  value="<?php echo $day_obj->session_3_price;?>"  placeholder="Enter Price" name="snacks_price[<?php echo $day_obj->entry_id;?>]" required="" style="width:80px;"></td>
