...
<div class="form-group" style="padding:10px;">
			   ...
			   <div class="form-group" style="padding:10px;">
                  ...
                  <div class="col-sm-10">
					...
					<input type="text"  value="<?php echo $form_data['pprice'];?>"  id="pprice" placeholder="Enter Purchase price per kg" name="pprice" <?php if($price_read_only) { echo "readonly";} ?> required="" style="width:200px;">  
                  </div>
                </div>
				
				  <input type="hidden" value="<?php echo $form_data['bf_qty'];?>"  id="pqty" placeholder="Enter Breakfast quantity" name="bf_qty" required="" style="width:200px;">
					<input type="hidden" <?php if($price_read_only) { echo "readonly";} ?> value="<?php echo $form_data['bf_price'];?>"  id="pprice" placeholder="Enter Breakfast price per kg" name="bf_price" required="" style="width:200px;">  
					...
					<input type="hidden"  value="<?php echo $form_data['lu_price'];?>"  id="pprice" placeholder="Enter Lunch price per kg" name="lu_price"  <?php if($price_read_only) { echo "readonly";} ?> required="" style="width:200px;">  
					...
					<input type="hidden" value="<?php echo $form_data['sn_price'];?>"  id="pprice" placeholder="Enter Snacks price per kg" name="sn_price" <?php if($price_read_only) { echo "readonly";} ?> required="" style="width:200px;">  

				 
				<div class="form-group" style="padding:10px;">
                  <label for="inputEmail3" class="col-sm-2 control-label">All Sessions</label>
                  ...
                  <div class="col-sm-10">
					...
					<input type="text" value="<?php echo $form_data['di_price'];?>"  id="pprice" placeholder="Enter Dinner price per kg" name="di_price" <?php if($price_read_only) { echo "readonly";} ?> required="" style="width:200px;">  
                  </div>
                </div>						
