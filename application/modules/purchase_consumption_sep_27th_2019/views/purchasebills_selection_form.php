              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  <div class="input-group-addon">
                   ...
                   <select required   name="school_id" style="height:32px" class="form-control pull-right search" >
                ...
                <div class="input-group date">
                  <div class="input-group-addon">
                   ...
                   <select required name="item_id" style="height:32px" class="form-control pull-right search" >
