...
<div class="box">
            <div class="box-header">
             <h4>Report from <b><?php echo $from_date_dp; ?> </b> To <b><?php echo $to_date_dp;?></b> </h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               <div><A class="btn btn-info pull-right" href='<?php echo site_url('report_itemwise/itemreport/'.$download_link);?>'>Download Report</a></div>
			  <A class="btn btn-info pull-right" href='<?php echo site_url('report_itemwise');?>'>Go Back</a></div>
			  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
				 ...
				 foreach($daily_item_details->result() as $item) {  
				  ...
				  if($item->purchase_quantity ==0 && $item->consumed_qty==0)
				  {
						continue;
				  }
