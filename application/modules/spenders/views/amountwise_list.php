            ...
            <div class="box-body">
			  ...
			  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
				 ...
				 foreach($rset->result() as $school) { 						$encoded_params = $this->ci_jwt->jwt_web_encode(array('school_id'=>$school->school_id,'rdate'=>$rdate));				 ?>               				 <tr role="row " class="odd ">
                  <td class="sorting_1"> 
				 <b> <?php echo $school->name;?></b></td>
                   ...
                   <td>
				    ...
				    <td>
					  					 <a href="<?php echo site_url("spenders/items_list_popup/".$encoded_params);?>" data-toggle="modal" data-target="#myModal" data-remote="false" class="btn btn-default">    View Items</a>
				   </td> 
