...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
        ...
        <!-- Main content -->
        <div class="content body"> <div id="contact_info" style="background-color:#e05616;color:#FFF;font-weight:bold;height:65px; padding:5px;"><h4>For any queries Please contact in DTWO office (DEO) : <?php $district_id =  $this->session->userdata("district_id");
$deo_data_rs = $this->db->query("select * from district_deos where district_id=?",array($district_id));
if($deo_data_rs->num_rows()!=0)
{
	echo  $deo_data_rs->row()->deo_name.". Cell :<a style='color:#FFF;' href='tel:+91-".$deo_data_rs->row()->contact_number."'>  ".$deo_data_rs->row()->contact_number."</a>" ;
}
