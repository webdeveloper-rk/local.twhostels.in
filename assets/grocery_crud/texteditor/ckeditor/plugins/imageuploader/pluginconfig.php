...
$foldershistory[] = $useruploadfolder;
    ...
    $useruploadfolder = "test/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "test/ckeditor/plugins/imageuploader/uploads";
        

    $useruploadfolder = "test/imagesuploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "test/imagesuploads";
    ...
    $useruploadfolder = "/imagesuploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "/imagesuploads";
