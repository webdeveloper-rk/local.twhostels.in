...
class School extends MX_Controller {
	...
	function openingbalance_entryform($item_id=null)
	{
		...
		$sql = "select item_id from balance_sheet where entry_date='2016-08-31'  and record_type='closing_balance' and school_id='$school_id' and item_id='$item_id' and 	closing_quantity='0.00' and curdate()<'2017-01-01'";
