...
<div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">choose dates</h3>
...
<br><br>
            ...
            <div class="row">
			 ...
			 <div id="wrap" class="container"> 
			 <label>Choose one School</label><br>
            <div class="row">
                <div class="col-sm-5">
                    <select name="school_selected[]" id="school_to" class="form-control" size="8"  >
                       <?php foreach($school_rs->result() as $row)
			 {				// print_a($row);
				echo "<option value='".$row->school_id."'>".  $row->school_code." - " .$row->name." - ".$row->village." - ".$row->district_name."</option>" ;
			 }
			 ?>
                    </select>
                </div>
