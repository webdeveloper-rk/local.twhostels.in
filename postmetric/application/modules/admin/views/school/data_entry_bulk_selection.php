            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  <div class="input-group-addon">
                   ...
                   <select name="school_id" style="height:32px" class="form-control pull-right " >
                ...
                <div class="input-group date">
                  <div class="input-group-addon">
                   ...
                   <select name="item_id" style="height:32px" class="form-control pull-right " >
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <select name="month" style="height:32px" class="form-control pull-right " >
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <select name="year" required style="height:32px" class="form-control pull-right " >
					 <?php
						$start_year = 2017;
						$current_year = date('Y');
