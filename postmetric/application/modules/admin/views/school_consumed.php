			...
			<form   role="form" class="form-horizontal"   action=""  method="post" onsubmit="return validate(this)">
			 ...
			 ?>
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="datepicker form-control" value="<?php echo $this->input->post('school_date');?>" id="school_date" placeholder="Select Date" name="school_date" required>
                  </div>
                </div>
