...
<b> Total schools count : <?php echo $rset->num_rows();?></b> <a href="<?php echo site_url('admin/subadmin/purchasebills');?>"><b>Go back</b></a>
                ...
                <tbody>
				 ...
				 <b> <?php echo $school->name;?></b></td>
                   ...
                   <td>
				    ...
				    <td>
					 <?php  echo isset($uploads[$school->school_id])?$uploads[$school->school_id]:0;  ?>   | <a href="<?php echo site_url("gallery/manage/admingallery/".$school->school_id);?>">View Bills</a>
				   </td> 
