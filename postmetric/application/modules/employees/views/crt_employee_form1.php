                   ...
                   <div class="col-xs-6">
					...
					<div class="col-xs-6">
					 <label>Name of the school at which CRT was joined first *</label>
                      <input type="firstschoolname" class="form-control" required name="param[firstschoolname]" value="<?php echo @$emp_info->email;?>" id="firstschoolname" placeholder="Enter email">
                    </div>
...
<div class="row">
        	...
        	<div class="col-md-6">
                      ...
                      <input type="text" name="param[bankname]"  onkeypress="return onlyAlphabets(event,this);" value="<?php echo @$emp_info->appsc_year;?>" required  class="form-control" placeholder="bankname"/>
                    </div>  
					
					
					<div class="col-md-6">
                      <label>ACCOUNT HOLDER NAME *</label>
                      <input type="text" name="param[acc_name]"  value="<?php echo @$emp_info->appsc_year;?>" required  class="form-control" placeholder="acc_name"/>
                    </div>  
					
					<div class="col-md-6">
                      <label>ACCOUNT NUMBER *</label>
                      <input type="number" name="param[acc_number]" id="tentacles" value="<?php echo @$emp_info->appsc_year;?>" required  class="form-control" placeholder="acc_number"/>
                    </div>  
					
					<div class="col-md-6">
                      <label>IFSC CODE *</label>
                      <input type="text" name="param[ifsccode]"  value="<?php echo @$emp_info->appsc_year;?>" required  class="form-control" placeholder="ifsccode"/>
                    </div>  
