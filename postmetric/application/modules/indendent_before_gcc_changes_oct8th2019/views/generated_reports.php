...
<a href="<?php echo site_url("indendent");?>" class="btn btn-info pull-right">  Go back to generate Indent  </a>
<br><br><br>
            ...
            <!-- /.box-header -->
			  ...
			  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
				 ...
				 $vieweditencoded =   $this->ci_jwt->jwt_web_encode(array('indent_date'=>$item->indent_date,"school_id"=>$item->school_id,'dp_date'=>$item->dp_date));
				 ?>
				 <tr  >
							...
							aria-label="Rendering engine: activate to sort column descending" style="widtd: 126px;"><?php echo  $item->dp_date;?></td> 
							 ...
							 <td class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" 
							aria-label="Rendering engine: activate to sort column descending" style="widtd: 126px;"><a href="<?php echo site_url("indendent/viewindent/".$vieweditencoded); ?>" class="btn btn-info pull-right">View/Edit </a></td> 
