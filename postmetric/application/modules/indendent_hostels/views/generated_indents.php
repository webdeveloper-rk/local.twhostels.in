                ...
                <tbody>
				 ...
				 <tr  >
							...
							aria-label="Rendering engine: activate to sort column descending" style="widtd: 126px;"><?php echo  $item->month_year;?></td> 
							 ...
							 <td class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" 
							aria-label="Rendering engine: activate to sort column descending" style="widtd: 126px;"><a href="<?php echo site_url("indendent_hostels/indent_schools_list/".$vieweditencoded); ?>" class="btn btn-info pull-right">View Hostels </a></td> 
							
							 
							 <td class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" 
							aria-label="Rendering engine: activate to sort column descending" style="widtd: 126px;">
							<?php if($item->submited_to_gcc==1) { ?> Submitted to GCC on <?php echo  $item->gcc_submitted_date;?><?php } ?>
