...
<div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"> Schools not implementing menu</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
...
<?php if($result==1) { ?>
<h3><span style="color:#FF0000;"><?php echo ucfirst($item_name);?></span> -   Schools not implemented menu [ <?php echo $report_date;?> ] </h3>
<b> Missed schools count : <?php echo $rset->num_rows();?></b> 

<a class='noprint btn btn-info ' href="#" onclick="javascript:window.print()"><b>Print</b></a>
