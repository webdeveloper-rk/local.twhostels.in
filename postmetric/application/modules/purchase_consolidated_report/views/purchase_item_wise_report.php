...
<h3>Purchases - Item Report<?php ?></h3>
<?php 
...
<div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Choose item and dates to get the report</h3>
            </div>
            <div class="box-body">
			 ...
			 <!-- Date -->
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="fromdate" required   value="<?php echo $from_date;?>"   class="form-control pull-right datepicker"  >
                </div>
                <!-- /.input group -->
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="todate" required value="<?php echo $to_date;?>"    class="form-control pull-right datepicker"   >
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
