...
<div class="form-group" style="padding:10px;">
			   ...
			   <div class="form-group" style="padding:10px;">
                  ...
                  <div class="col-sm-10">
					...
					<input type="text"  value="<?php echo $form_data['pprice'];?>"  id="pprice" placeholder="Enter Purchase price per kg" name="pprice" required="" style="width:200px;">  <br>
					 
                  </div>
                </div>
				
				 <div class="form-group" style="padding:10px;">
                  <label for="inputEmail3" class="col-sm-2 control-label">Select Vendor </label>

                  <div class="col-sm-10">
                    <select class=' search' name="vendor_id" id='vendor_id'   style="width:400px;">
		...
		<?php } ?>
					...
					<input type="hidden" value="<?php echo $form_data['bf_price'];?>"  id="pprice" placeholder="Enter Breakfast price per kg" name="bf_price" required="" style="width:200px;">  
				...
				<div class="form-group" style="padding:3px;"> 
                  <label for="inputEmail3" class="col-sm-2 control-label"><!--Dinner-->All Sessions</label>
...
<?php if($ajaxform !="yes") { ?>
				<a href='<?php echo site_url('purchase_consumption');?>' onclick="return confirm('Are you sure to cancel?')" class="btn btn-info pull-right">Cancel</a>&nbsp;&nbsp;&nbsp;&nbsp;
<?php } ?>
