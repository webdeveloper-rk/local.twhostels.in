...
<h3>Purchase Bills OLD[ <?php echo $report_date;?> ] </h3>
<b> Total schools count : <?php echo $rset->num_rows();?></b> <a href="<?php echo site_url('report_purchase_bills');?>"><b>Go back</b></a>
                ...
                <tbody>
				 ...
				 <b> <?php echo $school->name;?></b></td>
                   ...
                   <td>
				    ...
				    <td>
					 <?php  echo isset($uploads[$school->school_id])?$uploads[$school->school_id]:0;  ?>   | 					 <a href="<?php echo site_url("report_purchase_bills/admingallery/".intval($school->school_id)."/".$encoded_date);?>">View Bills</a>
				   </td> 
