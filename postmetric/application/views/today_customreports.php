...
<?php } ?>
  ...
  <table class="table table-bordered table-striped  "  >
	<tr class='bold'><td align="center"><?php echo $this->config->item('society_name'); ?>,<?php echo $schooldata->name; ?></td></tr>
	...
	<!--<tr class='bold'><td align="center"> <a href="#" id="tlink"  onclick='togglezeros()'>show/hide Zero Consumed Quantities</a> </b></span></td></tr>-->
	<tr>
		<td>
